 ...
 */
public class SP_AS extends antframework.algorithms.AntSystem{

    public SP_AS(){}

    public SP_AS(Enviroment E) {
        super(E);
    }

    public SP_AS(String graphLocation, int problemInitialNode, int problemDestinationNode, int parametersSet) throws Exception{
        ...
        /* Set parameters */
        this.setParam(SP_AS.initialNode  , problemInitialNode);
        this.setParam(SP_AS.destinationNode , problemDestinationNode);
        ...
        switch(parametersSet){
            case 0:
                this.setParam(SP_AS.maxNumIterations , 5);
                this.setParam(SP_AS.pheromonesEvaporationRate, 0.8);
                this.setParam(SP_AS.alpha, 0.5);
                this.setParam(SP_AS.beta, 0.5);
                Env.setAnts(5);
                break;
            case 1:
                this.setParam(SP_AS.maxNumIterations , 50);
                this.setParam(SP_AS.pheromonesEvaporationRate, 0.75);
                this.setParam(SP_AS.alpha, 0.5);
                this.setParam(SP_AS.beta, 0.75);
                Env.setAnts(5);
                break;
            case 2:
                this.setParam(SP_AS.maxNumIterations , 100);
                this.setParam(SP_AS.pheromonesEvaporationRate, 0.70);
                this.setParam(SP_AS.alpha, 0.85);
                this.setParam(SP_AS.beta, 0.75);
                Env.setAnts(10);
                break;
            case 3:
                this.setParam(SP_AS.maxNumIterations , 200);
                this.setParam(SP_AS.pheromonesEvaporationRate, 0.65);
                this.setParam(SP_AS.alpha, 0.85);
                this.setParam(SP_AS.beta, 0.85);
                Env.setAnts(15);
                break;
        }
        /* set enviroment*/
