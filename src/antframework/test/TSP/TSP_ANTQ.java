 ...
 */
public class TSP_ANTQ extends antframework.algorithms.AntQ {

    public TSP_ANTQ(Graph G, int problemInitialNode, int problemDestinationNode, int parametersSet) throws Exception{
        /* Set enviroment */
        Enviroment Env = new Enviroment( G /* Graph */ , true /* random pheromone trail */);
        /* Set parameters */
        this.setParam(TSP_ANTQ.initialNode  , problemInitialNode);
        this.setParam(TSP_ANTQ.destinationNode , problemDestinationNode);
        switch(parametersSet){
            case 0:
                this.setParam(TSP_ANTQ.maxNumIterations , 10000);
                this.setParam(TSP_ANTQ.alpha, 0.5);
                this.setParam(TSP_ANTQ.beta , 1);
                this.setParam(TSP_ANTQ.maxCandidates , Math.floor(G.getM().getColumns() / 2));
                this.setParam(TSP_ANTQ.r_0 , 0.35);
                this.setParam(TSP_ANTQ.ro_1 , 0.25);
                this.setParam(TSP_ANTQ.ro_2 , 0.25);
                this.setParam(TSP_ANTQ.tau_0 , 0.1);
                this.setParam(TSP_ANTQ.gamma , 0.5);
                Env.setAnts(10);
                break;
            case 1:
                this.setParam(TSP_ANTQ.maxNumIterations , 100);
                this.setParam(TSP_ANTQ.alpha, 0.25);
                this.setParam(TSP_ANTQ.beta , 1.25);
                this.setParam(TSP_ACS.maxCandidates , Math.floor(G.getM().getColumns() / 2));
                this.setParam(TSP_ANTQ.r_0 , 0.3);
                this.setParam(TSP_ANTQ.ro_1 , 0.2);
                this.setParam(TSP_ANTQ.ro_2 , 0.2);
                this.setParam(TSP_ANTQ.tau_0 , 0.1);
                this.setParam(TSP_ANTQ.gamma , 0.75);
                Env.setAnts(1000);
                break;
            case 2:
                this.setParam(TSP_ANTQ.maxNumIterations , 10000);
                this.setParam(TSP_ANTQ.alpha, 0.15);
                this.setParam(TSP_ANTQ.beta , 1.75);
                this.setParam(TSP_ACS.maxCandidates , Math.floor(G.getM().getColumns() / 3));
                this.setParam(TSP_ANTQ.r_0 , 0.25);
                this.setParam(TSP_ANTQ.ro_1 , 0.15);
                this.setParam(TSP_ANTQ.ro_2 , 0.15);
                this.setParam(TSP_ANTQ.tau_0 , 0.1);
                this.setParam(TSP_ANTQ.gamma , 1);
                Env.setAnts(1000);
                break;
            case 3:
                this.setParam(TSP_ANTQ.maxNumIterations , 250);
                this.setParam(TSP_ANTQ.alpha, 0.1);
                this.setParam(TSP_ANTQ.beta , 2);
                this.setParam(TSP_ACS.maxCandidates , Math.floor(G.getM().getColumns() / 3));
                this.setParam(TSP_ANTQ.r_0 , 0.2);
                this.setParam(TSP_ANTQ.ro_1 , 0.1);
                this.setParam(TSP_ANTQ.ro_2 , 0.1);
                this.setParam(TSP_ANTQ.tau_0 , 0.1);
                this.setParam(TSP_ANTQ.gamma , 1.25);
                Env.setAnts(25);
                break;
        }
        /* set enviroment*/
