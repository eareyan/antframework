...
public class ANTQ extends antframework.test.SP.SP_ANTQ implements Runnable {
    private panelGrafo S;

    public ANTQ(){}

    public ANTQ(Graph G,panelGrafo S,int ants,int paramInitalNode,int paramDestinationNode,int iterations,double paramBeta,double paramCandidatos, double paramR0, double paramTau, double paramRo_1,double paramRo_2,double paramGamma)throws Exception{
        super();
        this.S = S;
        /* Set enviroment */
        ...
        this.setParam(gamma , paramGamma);
    }
    public void run(){
        try{
            ...
            //Reportar resultados
            S.reportResults("HQ",bestSolution.toString(),f(this.getBestSolution()),end-begin);
        }catch(Exception e){
